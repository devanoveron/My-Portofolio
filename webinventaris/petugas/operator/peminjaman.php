                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="detailpeminjaman.php?id=<?=$data['id_peminjaman']?>"><i class="fa fa-eye" style="color: green;"></i></a> <a href="../../config/deletepeminjamanop.php?id=<?= $data['id_peminjaman']; ?>" onclick="return confirm('yakin Data ini akan dihapus?')"> <i class="fa fa-trash" style="color: red;"></i></a></td>
                          </tr>
                          <?php $no++;
                           } ?>
                        </tbody>
