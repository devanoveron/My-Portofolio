    ...
    <div class="body">
        <div class="sidebar">
            ...
            <ul class="sidemenu">
                ...
                </li>\<li><i class="fa fa-power-off"></i><a href="index.php">LogOut</a></li>
            </ul>
        </div>

        <div class="homepengguna">
            <h3>PENGGUNA</h3>
            <a href="petugas.php" class="btn btn-outline-dark"> PETUGAS  <i class="fa fa-arrow-circle-right" style="margin-left: 80%;"></i></a>
            <a href="user.php" class="btn btn-outline-dark"> USER  <i class="fa fa-arrow-circle-right" style="margin-left: 86%;"></i></a>
        </div>
