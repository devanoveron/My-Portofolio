                ...
                <div class="col">
                  <div class="card" style="width: 100%;">
                    <div class="card-header">
                      <a href="tambahruang.php" class="btn btn-primary">Tambah</a>
                      ...
                      <table class="table table-striped">
                        ...
                        <?php $no=1; ?>
                          ...
                          <th scope="row"><?= $no; ?></th>
                            ...
                            <td> <a href="editruang.php?id=<?=$data['id_ruang']?>"><i class="fa fa-edit" style="color: blue;"></i></a> <a href="../../config/deleteruang.php?id=<?= $data['id_ruang']; ?>" onclick="return confirm('yakin Data ini akan dihapus?')"> <i class="fa fa-trash" style="color: red;"></i></a></td>
                          </tr>
                          <?php $no++; ?>
                            <?php endwhile; ?>
                        </tbody>
