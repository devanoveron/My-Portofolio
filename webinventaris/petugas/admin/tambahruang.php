...
<body>
    ...
    <div class="body">
        ...
        <div class="kontentambah">
                ...
                <form class="need-validation" novalidate method="post" action="../../config/prosestambahruang.php">
                    <div class="card" style="width: 90%;">
                     <div class="form">   
                        <div class="form-group">
                            <label for="nb">Nama Ruang</label>
                            <input type="text" class="form-control is" name="nama_ruang" id="nb" placeholder="masukan nama ruang" required>
                          </div>
                          <div class="form-group">
                            <label for="j">Kode Ruang</label>
                            <input type="text" class="form-control" name="kode_ruang" id="formGroupExampleInput" placeholder="masukan kode ruang" required>
                          </div>
                          <div class="form-group">
                          ...
                          <a href="ruang.php" class="btn btn-danger">Kembali</a>   
                  </form>
                  <br><br>
                </div>
                </div>
