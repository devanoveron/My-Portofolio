...
<body>
    ...
    <div class="body">
        ...
        <div class="konten">
            ...
            <a href="kategori.php" class="btn btn-success"><i class="fa fa-list"></i> KATEGORI  <i class="fa fa-arrow-circle-right" style="margin-left: 76%;"></i></a>
            ...
            <a href="pengguna.php" class="btn btn-primary"><i class="fa fa-user-circle"></i> PENGGUNA  <i class="fa fa-arrow-circle-right" style="margin-left: 73%;"></i></a>
            <a href="ruang.php" class="btn btn-danger"><i class="fa fa-home"></i> RUANG  <i class="fa fa-arrow-circle-right" style="margin-left: 79%;"></i></a>
        </div>
