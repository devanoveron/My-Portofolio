                ...
                <div class="col">
                  <div class="card" style="width: 100%;">
                    <div class="card-header">
                      <a href="tambahpetugas.php" class="btn btn-primary">Tambah</a>
                      ...
                      <table class="table table-striped">
                        ...
                        <?php $no=1; ?>
                          ...
                          <th scope="row"><?= $no; ?></th>
                            ...
                            <td><?= $data['username']; ?></td>
                            <td><?= $data['id_level']; ?></td>
                            <td> <a href="../../config/deletepetugas.php?id=<?= $data['id_petugas']; ?>" onclick="return confirm('yakin Data ini akan dihapus?')"> <i class="fa fa-trash" style="color: red;"></i></a></td>
                          </tr>
                          <?php $no++; ?>
                            <?php endwhile; ?>
                        </tbody>
